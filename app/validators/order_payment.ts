 ...
 */
export const createOrderPaymentValidator = (companyId: number, locationId: number) => vine.compile(
    vine.object({
        orderId: vine
            .number()
 ...
 */
export const createMultipleOrderPaymentsValidator = (companyId: number, locationId: number) => vine.compile(
    vine.object({
        orderId: vine
            .number()
            .exists(async (db, value) => {
